            ...
            >
              ...
              <div>
                ...
                <div className="space-y-2 pt-2 border-t border-slate-400/30 mt-4">
                  <Link
                    href={`/dashboard/skahverse/research-group/${group.id}/view`}
                  >
                    <Button
                  ...
                  {(role === "TEACHER" || role === "WEB_MASTER") && (
                    <>
                      <Link
                        href={`/dashboard/skahverse/research-group/${group.id}`}
                      >
                        <Button
                          variant="cyberGradient"
                          size="sm"
                  ...
                  <Link
                    href={`/dashboard/skahverse/research-group/${group.id}/attachments`}
                  >
                    <Button
                      variant="cyberGradient"
                      size="sm"
                  ...
                  <Link
                    href={`/dashboard/skahverse/research-group/${group.id}/projects/create`}
                  >
                    <Button
                      variant="cyberGradient"
                      size="sm"
